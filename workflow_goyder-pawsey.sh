...
conda activate /scratch/pawsey1018/rhodgson/envs/base_python
set -u

# Default values. NOTE may need to change TAX_DB if using a different version...
DATA_DIR="./data"
OUT_DIR="./results"
TAX_DB="./resources/k2_pluspf_20251015"
...
jid_cpm=$(sbatch --export=ALL \
  ...
  steps-pawsey/CPM_prok-braken.sh)
...
jid_CPM_sf=$(sbatch --export=ALL \
  ...
  steps-pawsey/CPM_prok-superfocus.sh)
